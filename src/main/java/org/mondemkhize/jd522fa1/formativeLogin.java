...
public class formativeLogin {
    private static boolean loginSucceed;
    ...
    public static void login(Window component,String username, String password){
        if(username.equals(uName1) && password.equals(pWord1)){
            ...
            JOptionPane.showMessageDialog(
                    component, 
                    "Congratulations "+ studentName1 +", You have made it to the second year. Wishing you all the best"
            );
        }
            ...
            JOptionPane.showMessageDialog(
                    component,
                    "Congratulations " + studentName2 + ", You have made it to the second year. Wishing you all the best"
            );
        }
    }
